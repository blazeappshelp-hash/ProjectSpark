...
interface GLSLHillsProps {
  ...
  planeSize?: number;
  speed?: number;
  /** gray value 0–1, default 0.55 works in both light and dark */
  grayLevel?: number;
}
...
export function GLSLHills({
  ...
  useEffect(() => {
    ...
    const uniforms: {
      ...
      grayLevel: THREE.IUniform<number>;
    } = {
      time: { value: 0 },
      grayLevel: { value: grayLevel },
    };
    ...
    const mesh = new THREE.Mesh(
      ...
      new THREE.RawShaderMaterial({
        ...
        fragmentShader: `
          ...
          void main(void) {
            float opacity = (96.0 - length(vPosition)) / 256.0 * 0.12;
            vec3 color = vec3(grayLevel);
  ...
  }, [cameraZ, planeSize, speed, grayLevel]);
